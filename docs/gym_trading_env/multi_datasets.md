Title: Multi datasets environment

URL Source: http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html

Markdown Content:
[Back to top](http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html#)
...
In my opinion, one dataset is not enough. The agent will overfit and won’t be able to generalize. My solution is simple, adding multiple datasets to the environment. I present you the _MultiDatasetTradingEnv_.

Multi Dataset Trading Environment[#](http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html#multi-dataset-trading-environment "Permalink to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### How to use ?[#](http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html#how-to-use "Permalink to this heading")

You need to specify a [glob path](https://docs.python.org/3.6/library/glob.html) that gather all of the datasets (in .pkl format). Imagine you have several preprocessed datasets in a folder named `preprocessed_data` .
...
### Easy preprocess[#](http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html#easy-preprocess "Permalink to this heading")
...
[MultiDatasetTradingEnv documentation](https://gym-trading-env.readthedocs.io/en/latest/documentation.html#gym_trading_env.environments.TradingEnv)

### Run the environment[#](http://gym-trading-env.readthedocs.io/en/latest/multi_datasets.html#run-the-environment "Permalink to this heading")
