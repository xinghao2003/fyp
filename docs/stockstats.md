...
URL Source: http://pypi.org/project/stockstats/

Markdown Content:
Stock Statistics/Indicators Calculation Helper
----------------------------------------------

[![Image 1: build & test](https://pypi-camo.freetls.fastly.net/b9e29654956e06817aa3e4896e031201d3001c08/68747470733a2f2f6769746875622e636f6d2f6a65616c6f75732f73746f636b73746174732f616374696f6e732f776f726b666c6f77732f6275696c642d746573742e796d6c2f62616467652e737667)](https://github.com/jealous/stockstats/actions/workflows/build-test.yml)[![Image 2: codecov](https://pypi-camo.freetls.fastly.net/4218e7d10af2aa69bb59b80f07c3b420147bf17d/68747470733a2f2f636f6465636f762e696f2f67682f6a65616c6f75732f73746f636b73746174732f6272616e63682f6d61737465722f67726170682f62616467652e7376673f746f6b656e3d49464d443170564a3754)](https://codecov.io/gh/jealous/stockstats)[![Image 3: pypi](https://pypi-camo.freetls.fastly.net/8f37da03777f1bbf2ccb60bd292f249eac69ec85/68747470733a2f2f696d672e736869656c64732e696f2f707970692f762f73746f636b73746174732e737667)](https://pypi.python.org/pypi/stockstats)
...
[BSD-3-Clause License](https://pypi.org/project/stockstats/LICENSE.txt)
...
When retrieving data from yfinance, the resulting DataFrame may have a multi-index. This can cause issues with the wrap function.

To handle this, a workaround is provided to identify and extract the actual series when a multi-index is present. However, this approach has a limitation: new columns generated by stockstats will not include the additional column index.

The recommended solution is to disable the multi-level index when retrieving data from yfinance. This ensures compatibility without additional processing. An example is provided below:
...
By disabling the multi-level index, the DataFrame structure remains simple, and subsequent operations can be performed seamlessly.
...
Supertrend indicates the current trend.
 ...
 We use the [algorithm described here](https://medium.com/codex/step-by-step-implementation-of-the-supertrend-indicator-in-python-656aa678c111). It includes 3 lines:
...
#### [Chande Momentum Oscillator] ([https://www.investopedia.com/terms/c/chandemomentumoscillator.asp](https://www.investopedia.com/terms/c/chandemomentumoscillator.asp))
...
[https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/overlap/linreg.py](https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/overlap/linreg.py)
...
[https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/momentum/cti.py](https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/momentum/cti.py)
...
[https://www.tradingview.com/script/ajZT2tZo-Gaussian-Fisher-Transform-Price-Reversals-FTR/](https://www.tradingview.com/script/ajZT2tZo-Gaussian-Fisher-Transform-Price-Reversals-FTR/)

Implementation reference:

[https://github.com/twopirllc/pandas-ta/blob/084dbe1c4b76082f383fa3029270ea9ac35e4dc7/pandas_ta/momentum/fisher.py#L9](https://github.com/twopirllc/pandas-ta/blob/084dbe1c4b76082f383fa3029270ea9ac35e4dc7/pandas_ta/momentum/fisher.py#L9)
...
Implementation reference: [https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/momentum/qqe.py](https://github.com/twopirllc/pandas-ta/blob/main/pandas_ta/momentum/qqe.py)
...
We use [Github Issues](https://github.com/jealous/stockstats/issues) to track the issues or bugs.
...
*   Cedric Zhuang [jealous@163.com](mailto:jealous@163.com)
